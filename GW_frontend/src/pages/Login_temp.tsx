...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        localStorage.setItem('curent_user_token', data.token);
        toast({
  ...
  const handleAppleLogin = async () => {
    try {
      ...
      toast({
        title: "Success",
        description: "You have been logged in with Apple successfully",
      });
      navigate("/dashboard");
    } catch (error) {
      toast({
        title: "Error",
        description: "Failed to log in with Apple",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Log in to your  GadokskiWeather account
          </p>
        </div>
        ...
        <Card className="animate-scale-in">
          <CardHeader>
            ...
            <CardDescription>
              Access your weather insights dashboard
            </CardDescription>
          </CardHeader>
